...
export const SET_USER_EMISOR = 'SET_USER_EMISOR';
export const SET_MESSAGES_TO_SHOW = 'SET_MESSAGES_TO_SHOW';
export const UPDATE_MESSAGE_CHANNELS = 'UPDATE_MESSAGE_CHANNELS';
